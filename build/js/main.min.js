...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var siteLinks = document.querySelectorAll('a[href*="#"]');

  if (siteLinks.length >= 1) {
    var _iterator = _createForOfIteratorHelper(siteLinks),
        _step;

    try {
      var _loop = function _loop() {
        var siteLink = _step.value;
        siteLink.addEventListener('click', function (e) {
          e.preventDefault();
          var blockID = siteLink.getAttribute('href');
